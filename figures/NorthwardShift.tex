...
\node at (0cm,0cm) {\includegraphics[width=12cm]{Figure3_Mueller_etal_BotaMar_adjusted.jpg}};
\node [text centered] at (2.2cm,1.75cm) {\scriptsize{Recent records}};


\node at (-3.45cm,0.65cm) {\includegraphics[width=2cm]{KeithHiscock_LaminariaHyperborea.jpg}};
